...
export class GuildEntity extends BaseEntity {
	...
	@Column('boolean', { name: 'recruitment.enabled', default: false })
	public recruitEnabled?: string | null;

	@Column('varchar', { name: 'recruitment.channel', nullable: true, length: 19 })
	public recruitChannel?: string | null;

	@Column('varchar', { name: 'recruitment.officerChannel', nullable: true, length: 19 })
	public officerChannel?: string | null;
