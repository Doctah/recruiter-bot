...
import { BotCommand, BotCommandOptions } from './BotCommand';

export interface ModerationCommandOptions extends BotCommandOptions {
	requiredMember?: boolean;
	optionalDuration?: boolean;
}

export abstract class ModerationCommand<T = unknown> extends BotCommand {
	/**
